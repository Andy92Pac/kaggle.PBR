...
```{r}
df = data.frame(Modele = c('SVM', 'XGboost', 'Stacking XGboost RandomForest','Stacking SVM XGboost', 'Stacking SVM XGboost stretched'), LogLoss.kaggle = c(0.46203,0.45047,0.42802,0.42371,0.42065))
df
```
